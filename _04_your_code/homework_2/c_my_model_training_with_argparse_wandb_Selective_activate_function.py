...
def main(args):
  ...
  config = {
    ...
    'activation_fn': args.activation_fn, # 이 줄을 추가
  }
...
if __name__ == "__main__":
  ...
  parser.add_argument( # 이 줄을 추가
      "-a", "--activation_fn", type=str, default="ReLU", help="Activation function (ReLU, Sigmoid, ELU, Leaky ReLU)"
    )
